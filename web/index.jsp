...
<body>
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="clientes" target="FramePrincipal">EDITAR CLIENTES</a>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="reportes.jsp" target="FramePrincipal">REPORTES</a>
                </li>
            </ul>

            <div class="dropdown">
                <button class="btn dropdown-toggle" type="button" id="btnCerrarSesion" data-toggle="dropdown" aria-expanded="false">
                    LOGIN
                </button>
    ...
    <iframe name="FramePrincipal" height="100%" width="100%"></iframe>
    </div>
</body>
</html>
